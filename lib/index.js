...
exports.Pxls = exports.BufferType = exports.PxlsColor = exports.TRANSPARENT_PIXEL = exports.UsersMessage = exports.PixelsMessage = exports.Pixel = exports.Message = void 0;
...
class Pxls extends EventEmitter {
    ...
    async sync() {
        ...
        const buffers = await Promise.all(bufferSources.map(async ([type, url]) => {
            const buffer = await util_1.pipe(got.stream(url), new Uint8Array(width * height));
            switch (type) {
